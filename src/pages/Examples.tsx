        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Browse professionally crafted resume examples by industry to inspire your own resume
            </p>
          </div>
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 mb-8">
              We're currently working on adding resume examples for different industries and job positions.
              Check back soon!
            </p>
            <Link to="/builder">
