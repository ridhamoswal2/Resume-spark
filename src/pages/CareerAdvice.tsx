      ...
      <main className="container py-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Career Advice</h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Expert guidance to help you advance your career and achieve your professional goals
            </p>
          </div>
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 mb-8">
              Our career advice section is currently being developed. Check back soon for expert guidance!
            </p>
            <Link to="/builder">
